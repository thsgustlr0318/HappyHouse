						...
						$(document).ready(function(){
							...
							,function(data, status){
								...
								$.each(data, function(index, vo) {
									...
									+ "<h4>" + vo.aptName + "</h4>"
									+ "<h6 class='media-heading' id='deal'> 번호: " + vo.no + "</h6>"
									+ "<h6 class='media-heading' id='deal'> 동: " + vo.dong + "</h6>"
									+ "<h6 class='media-heading' id='deal'> 평수: " + vo.area + "</h6>"
									+ "<h6 class='media-heading' id='deal'> 층수: " + vo.floor + "</h6>"
									+ "<h6 class='media-heading' id='deal'> 설립 년도: " + vo.buildYear + "</h6>"
									+ "<h6 class='media-heading' id='deal'> 거래 년도: " + vo.dealYear + "</h6>"
									+ "<hr>";
									+ "</div>";
									+ "</div>";
									$("#test").append(str);
