...
<body>
	...
	<div class="auth-wrapper">
        <div class="auth-content">
            ...
            <form method="post" action="${root}/user/join" id="joinForm">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="cellphone" id="cellphone" class="form-control" placeholder="010-5577-6688">
                    </div>
                    <div class="input-group mb-3">
                        <input type="text" name="address" id="address" class="form-control" placeholder="Click!">
                    </div>
